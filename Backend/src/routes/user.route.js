...
import {getcaptaindata, getOtp, getProfile, loginUser, logoutUser, registerUser} from "../controllers/user.controller.js"
...
UserRouter.route('/user-get-captainData').get(verifyJWTUser,getcaptaindata);
export {UserRouter}